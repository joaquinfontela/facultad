...
import javafx.scene.paint.Color;
    ...
    public class LayoutEmpate extends StackPane {
        ...
        public LayoutEmpate(Jugador jugadorGanador, Jugador jugadorPerdedor) {
            ...
            crearLayoutParteJugadorArriba(jugadorGanador);
            crearLayoutParteJugadorAbajo(jugadorPerdedor);
        }
